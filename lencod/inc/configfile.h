...
Mapping Map[] = {
    ...
    {"ExtractFrmRng",           &cfgparams.ExtractFrmRng,               1,  0,                  0, 0.0,		0.0,			EX_FRM_RNG_SIZE,},
    {"ExtKeyFile",		        &cfgparams.ExtKeyFile,			        1,	0.0,				0, 0.0,		0.0,			FILE_NAME_SIZE,},
    {"ExtKeyFileEnable",		&cfgparams.ExtKeyFileEnable,			0,	1.0,				0, 0.0,		0.0,			},
