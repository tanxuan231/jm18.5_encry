...
#define MAX_NUM_DPB_LAYERS        2  //最大DPB数(decoded picture buffer)
...
#define  MAXSLICEPERPICTURE           100  //一帧中最大的slice数
...
enum {
  ...
  SMB4x8       =  6,
  SMB4x4       =  7,
  P8x8         =  8,  //b8_mode_table[6]  = {0, 4, 5, 6, 7};
  I4MB         =  9,
  I16MB        = 10,
  IBLOCK       = 11,
  SI4MB        = 12,
