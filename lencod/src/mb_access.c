 ...
 *	得到相邻像素点的绝对坐标和在其所属宏块内 的相对坐标
 * \param currMB
 *   current macroblock
 * \param xN   (in)相邻像素点相对当前宏块原点的坐标
 *    input x position
 * \param yN   (in)
 *    input y position
 * \param mb_size (in)
 *    Macroblock size in pixel (according to luma or chroma MB access)
 * \param pix   返回位置信息(相对当前宏块原点的坐标)
 *    returns position informations
 *  xN<0&&yN<0 D blk
 *  xN<0&&0<yN<maxWH A blk  
 ************************************************************************
 */
