...
typedef enum
{
  PAR_OF_ANNEXB,    //!< Annex B byte stream format 字节流格式码流(主要用于存储)
  PAR_OF_RTP       //!< RTP packets in outfile (主要用于网络)
} PAR_OF_TYPE;
...
typedef enum
{
  ...
  Q_PEL    //!< Quarter Pel refinement 1/4像素细化
} MELevel;
